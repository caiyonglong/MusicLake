...
import com.cyl.musiclake.ui.activity.CommentActivity;
import com.cyl.musiclake.ui.activity.NearPeopleAcivity;
...
//            ((FooterViewHolder) holder).rcvLoadMore.isShown();
        ...
        if (holder instanceof CommViewHolder){
            ...
            newHolder.user_name.setText(dynamic.getUser().getUser_name());
...
//        newHolder.content_time.setText(FormatUtil.getTimeDifference(dynamic.getSecret_time()));
            com.nostra13.universalimageloader.core.ImageLoader.getInstance().displayImage(
                    dynamic.getUser().getUser_img(), newHolder.user_logo, ImageUtils.getAlbumDisplayOptions());
