...
import com.cyl.musiclake.ui.adapter.CommentAdapter;
import com.cyl.musiclake.callback.CommentCallback;
import com.cyl.musiclake.callback.SecretCallback;
import com.cyl.musiclake.callback.StatusCallback;
import com.cyl.musiclake.mvp.model.community.Comment;
import com.cyl.musiclake.mvp.model.community.CommentInfo;
import com.cyl.musiclake.mvp.model.community.Secret;
import com.cyl.musiclake.mvp.model.community.SecretInfo;
...
public class CommentActivity extends BaseActivity {
    ...
    void tonear() {
        if (UserStatus.getstatus(this)) {
            if (!UserStatus.getUserInfo(this).getUser_id().equals(secret.getUser_id())) {
    ...
    void love() {
        String userid = "";
        if (UserStatus.getstatus(this)) {
            userid = UserStatus.getUserInfo(this).getUser_id();
        } else {
            ToastUtils.show(this, "请登录！");
            return;
        }
