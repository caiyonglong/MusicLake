...
public class FoundFragment extends BaseFragment {
    ...
    void toBaidu() {
        NavigateUtil.navigateFragment(getActivity(), BaiduPlaylistFragment.newInstance());
    }

    @OnClick(R.id.btn_netease)
    void toNetease() {
        NavigateUtil.navigateFragment(getActivity(), NeteasePlaylistFragment.newInstance());
    }
