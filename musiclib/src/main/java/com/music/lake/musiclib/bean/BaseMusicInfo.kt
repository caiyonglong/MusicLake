 ...
 * 版本：2.5
 */
class BaseMusicInfo() : Parcelable {
    //数据库存储id
    var id: Long = 0
    // 歌曲类型 本地/网络
    ...
    companion object CREATOR : Parcelable.Creator<BaseMusicInfo> {
        override fun createFromParcel(parcel: Parcel): BaseMusicInfo {
            return BaseMusicInfo(parcel)
        }

        override fun newArray(size: Int): Array<BaseMusicInfo?> {
